...
spectrograph_lib = RbLib.new('ATSpectrograph', 'libatspectrograph', '/usr/local/include/atspectrograph.h')
...
spectrograph_symbols = File.open("#{ENV['HOME']}/rb_andor/test/specdata/libatspectrograph_symbols", 'r') {|f| f.readlines.map{|line| line.chomp.split(' T ')[1]}}
